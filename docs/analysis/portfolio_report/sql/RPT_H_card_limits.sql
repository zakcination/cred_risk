/* =============================================================================
   ...
   «Количество выдач» по месяцу выдачи: 103 тыс. ₸ (09.2025), 59–97 тыс.
   ...
   ДЕФЕКТ ПРАВИЛА (прогон 24.09.2026). Концы 09.2025 и 08.2026 — 56 и 3 карты
   с лимитом; отношение средних на трёх картах — шум. Правило указало на (г),
   ответа оно не даёт. При повторном прогоне сравнивать периоды, а не месяцы,
   и порог числа карт фиксировать ДО прогона. Разбор — README, Р-8.
