...
FROM [risk_analytics].[loans_active] WHERE l_report_date = @AsOf
...
FROM [risk_analytics].[borrower] WHERE b_report_date = @AsOf
...
FROM [risk_analytics].[loan_account] WHERE la_reporting_date = @AsOf
...
FROM [risk_analytics].[pledges] WHERE c_reporting_date = @AsOf
