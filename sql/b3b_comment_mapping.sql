/* =============================================================================
   ПРОСТЫМ ЯЗЫКОМ:
   Приводим «сырые» комментарии по причинам выбытия займов (колонка E формы B3B)
   к официальному справочнику НБРК (списание / полное погашение / иное и т.д.),
   подставляем текст в колонки F/G/H и помечаем строки, требующие ручной проверки.
   ---------------------------------------------------------------------------
