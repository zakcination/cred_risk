/* =============================================================================
   ПРОСТЫМ ЯЗЫКОМ:
   По каждому займу из списка B3B смотрим его последнее фактическое состояние во
   всех системах-источниках (CL, Fenix, RS, карты) и помечаем те, что «пропали»
   из портфеля ещё до 2025 года — их наличие в отчёте за 2025 год спорно.
   ---------------------------------------------------------------------------
