/* =============================================================================
   ПРОСТЫМ ЯЗЫКОМ:
   На дату 01.07.2026 берём займы 3-й стадии (category=3, без списанных tag=11) и
   смотрим, сколько отсеивается на каждом шаге (тег, дата дефолта). Затем при
   мягком правиле (просрочка dpd ≤ n дней, n=1/3/7/10) считаем, сколько займов
   «оздоровилось» бы: количество, сумму, высвобождаемые провизии и % cure.
   ---------------------------------------------------------------------------
